...
public class AIInsightController {
    ...
    private AIInsightRequest mapRiskDataToRequest(Map<String, Object> data) {
        ...
        // Map breaches list so AI engine can generate proper insights
        List<com.incedo.ai_insight_service.model.RiskBreachDetail> breaches = new java.util.ArrayList<>();
        if (data.containsKey("breaches") && data.get("breaches") instanceof List<?> rawBreaches) {
            for (Object rawBreach : rawBreaches) {
                if (rawBreach instanceof Map<?, ?>) {
                    ...
                    com.incedo.ai_insight_service.model.RiskBreachDetail breach =
                        new com.incedo.ai_insight_service.model.RiskBreachDetail();
